...
import com.example.canorecoapp.databinding.FragmentNewsDetailsListsBinding
...
class NewsDetailsListsFragment : Fragment() {
    private lateinit var binding : FragmentNewsDetailsListsBinding
    ...
    override fun onCreateView(
        ...
        binding =  FragmentNewsDetailsListsBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun loadJsonFromRaw(resourceId: Int): String? {
        return try {
            val inputStream =this@NewsDetailsListsFragment.requireContext().resources.openRawResource(resourceId)
