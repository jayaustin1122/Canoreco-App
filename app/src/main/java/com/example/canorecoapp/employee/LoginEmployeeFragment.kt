                    ...
                    if (snapshot != null && snapshot.exists()) {
                        ...
                        when (userType) {
                            ...
                            "member" -> {
                                ...
                                Toast.makeText(this@LoginEmployeeFragment.requireContext(), "There seems to be an issue with your account. Please contact the admin for assistance.", Toast.LENGTH_SHORT).show()
                            }
                        }
                    } else {
